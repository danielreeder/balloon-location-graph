...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        print(df_ko4)
        df_kk7['temp'] = df_kk7[['comment']].apply(self.parse_comment, axis=1).apply(str.strip, args='C')
        df_ko4['temp'] = df_ko4[['comment']].apply(self.parse_comment, axis=1).apply(str.strip, args='C')
        df_kk7['temp'][0] = 0
        df_ko4['temp'][0] = 0
